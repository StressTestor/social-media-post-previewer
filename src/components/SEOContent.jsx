...
import { Layout, Download, Moon } from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className={`text-lg max-w-2xl mx-auto ${textColor}`}>
                        Create realistic social media post previews for Twitter, Instagram, LinkedIn, Facebook, and TikTok.
                        The perfect tool for social media managers, content creators, and marketers to visualize content before posting.
                    </p>
                </div>
